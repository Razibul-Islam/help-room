      ...
      <div className="md:flex gap-6 mt-4">
        <div className="md:w-[50%]">
          ...
          <p>
            ...
            esse quos quibusdam temporibus blanditiis ad totam quas natus in
            velit, rerum, obcaecati necessitatibus perferendis corrupti nemo
            nesciunt amet accusamus ipsam?
          </p>
        </div>
        <div className="md:w-[50%]">
